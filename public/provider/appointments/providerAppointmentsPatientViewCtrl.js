(function () {
  angular.module('app').controller('providerAppointmentsPatientViewCtrl', ['$scope', '$log', '$state', 'toastr', 'authService',
    ...
    function ($scope, $log, $state, toastr, authService, historyService,$localStorage, $rootScope) {
      ...
      historyService.getPatientDetailsByEmail($scope.email, function (result) {
