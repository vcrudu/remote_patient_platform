/**
 * Created by developer1 on 10/31/2016.
 */
/**
 * Created by Victor on 27/10/2015.
 */
(function() {
    angular.module('app').factory('memberHistoryService', ['$http', '$localStorage', 'appSettings', '_',
        function ($http, $localStorage, appSettings, _) {
            return {
                getHistories:function(success, error) {
                    ...
                    var req = {
                        method:'GET',
                        url:appSettings.getServerUrl()+'/v1/api/memberevents/'+$localStorage.memberemail,
                        headers:{
                ...
                getPatientDetails:function(success, error){
                     ...
                     var req = {
                        method:'GET',
                        url:appSettings.getServerUrl()+'/v1/api/patients/'+$localStorage.memberemail,
                        headers:{
                            'x-access-token': $localStorage.user.token
                        }
                    };
