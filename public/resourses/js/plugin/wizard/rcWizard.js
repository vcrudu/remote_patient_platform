...
//                    wizardElement.find('.form-wizard').children('li').eq(currentIndex - 1).find('.step').html('<i class="fa fa-check"></i>');
                ...
                var onTabShow = function (activeTab, navigation, currentIndex) {
                    ...
                    if (currentIndex > 0) {
                        wizardElement.find('.form-wizard').children('li').eq(currentIndex - 1).addClass('complete');
                        wizardElement.find('.form-wizard').children('li').eq(currentIndex - 1).find('.step').html('<i class="fa fa-check"></i>');
...
//                            .addClass("success");
                        ...
                        wizardElement.find('.form-wizard').children('li').removeClass('complete');
