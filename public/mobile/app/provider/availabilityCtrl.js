    ...
    .controller("ProviderAvailabilityCtrl",
        ['$scope', '$filter', '_', '$modal', '$mdpDatePicker', 'providerAvailabilityService', function($scope, $filter, _, $modal, $mdpDatePicker, providerAvailabilityService) {
                ...
                $scope.getAvailability = function(startDate, endDate){
                        ...
                        providerAvailabilityService.getAvailabilityByPeriod($scope.getCurrentTimeString(startDate), $scope.getCurrentTimeString(endDate), function(data){
                ...
                var applyEvent = function (session, date,updateEvent) {
                        ...
                        var backgroundColor = '#4caf50';
                        var eventTextColor = '#ffffff';
                        providerAvailabilityService.getAvailabilityByPeriod(moment(startDate).format("YYYY-MM-DD HH:mm:ss"), moment(endDate).format("YYYY-MM-DD HH:mm:ss"),function(data){
                                for(var i=0;i<data.length;i++){
                                        var intervals = data[i].intervals.split("-");
                                        ...
                                        controller: function ($scope, $modalInstance, event) {
                                                ...
                                                $scope.apply = function () {
                                                        ...
                                                        if ($scope.modification == "Add") {
                                                                providerAvailabilityService.addAvailability({
                                                                ...
                                                                providerAvailabilityService.editAvailability({
                                                                            availabilityString: availabilityString,
                                                                            dateString: dateString,
