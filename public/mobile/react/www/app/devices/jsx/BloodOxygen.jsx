        ...
        render: function() {
            return <div className="row has-separator buttons-container">
                <div className="col-xs-6">
                    { this.state.cancelButtonVisibility ? <input type="button" className="btn btn-default btn-footer pull-left" value="Cancel" onClick={this.handleCancel}></input> : null }
                </div>
                <div className="col-xs-6">
                    { this.state.nextButtonVisibility ? <input type="button" className="btn btn-default btn-footer pull-right" value="Next" onClick={this.handleNext}></input> : null }
                    { this.state.doneButtonVisibility ? <input type="button" className="btn btn-default btn-footer pull-right" value="Done" onClick={this.handleDone}></input> : null }
                    { this.state.retryButtonVisibility ? <input type="button" className="btn btn-default btn-footer pull-right" value="Retry" onClick={this.handleRetry}></input> : null }
                </div>
            </div>
        }
    });
